...
class ResumeParser:
    ...
    def __init__(self):
        ...
        self.connection_indicators = {
            "education": ["university", "college", "school", "academy", "institute", "degree", "bs", "ms", "phd", "mba"],
            "military": ["military", "army", "navy", "air force", "marine", "coast guard", "veteran", "officer", "enlisted"],
    ...
    def _extract_companies(self, text: str) -> List[str]:
        ...
        tech_companies = [
            ...
            "openai", "anthropic", "tesla", "spacex", "uber", "airbnb",
            "stripe", "coinbase", "dropbox", "slack", "zoom", "oracle",
            "ibm", "intel", "nvidia", "amd", "salesforce", "adobe",
            "c3.ai", "c3 ai", "palantir", "databricks", "snowflake"
        ]
    ...
    def _extract_skills(self, text: str) -> List[str]:
        ...
        frameworks = [
            ...
            "spring", "nodejs", "express", "rails", "laravel",
    ...
    def _extract_military(self, text: str) -> Optional[Dict]:
        ...
        military_keywords = [
            ...
            "usafa", "west point", "usma", "naval academy", "usna",
            "officer", "enlisted", "sergeant", "lieutenant", "captain", "major", "colonel"
        ]
        ...
        for keyword in military_keywords:
            if keyword in text:
                if "branch" not in military_info:
                    if any(branch in keyword for branch in ["air force", "army", "navy", "marine", "coast guard"]):
                        military_info["branch"] = keyword
                military_info["veteran"] = True
                
                # Check for academy
                if any(academy in keyword for academy in ["usafa", "usma", "usna", "west point", "naval academy"]):
    ...
    def _extract_certifications(self, text: str) -> List[str]:
        ...
        cert_patterns = [
            ...
            "pmp", "cissp", "ccna", "ccnp", "comptia", "scrum master",
            "six sigma", "itil", "cpa", "cfa"
        ]
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        roles = [
            ...
            "analyst", "scientist", "designer", "consultant", "lead",
            "senior", "principal", "staff", "founder", "ceo", "cto"
        ]
